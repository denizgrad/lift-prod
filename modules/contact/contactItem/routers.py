...
from modules.contact.contactItem.controller import *
from modules.user.auth.routers import token_required
from resources import app


class route_contactItem(AbstractResourceRoute):
    """
    ...
    def __init__(self):
        self.abstract = super(route_contactItem, self)
...
app.logger.debug("*** Route ContactItem api")
app.api.add_resource(
    route_contactItem,
    '/api/v1/contact/item',
    '/api/v1/contact/item/<mongoid>',
    endpoint='api-contact-item',
