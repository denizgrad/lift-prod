...
class route_controlPanelExtra(AbstractResourceRoute):
    """
    ...
    def __init__(self):
        self.abstract = super(route_controlPanelExtra, self)
...
app.api.add_resource(
    route_controlPanelExtra,
    '/api/v1/control/panel/extra',
    '/api/v1/control/panel/extra/<mongoid>',
    endpoint='api-control-panel-extra',
