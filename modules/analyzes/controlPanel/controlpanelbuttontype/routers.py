...
class route_controlPanelButtonType(AbstractResourceRoute):
    """
    ...
    def __init__(self):
        self.abstract = super(route_controlPanelButtonType, self)
...
app.api.add_resource(
    route_controlPanelButtonType,
    '/api/v1/control/panel/button/type',
    '/api/v1/control/panel/button/type/<mongoid>',
    endpoint='api-control-panel-button-extra',
