...
from modules.analyzes.machineEngine.enginespeed.controller import ControllerEngineSpeed
from modules.user.auth.routers import token_required
from resources import app


class router_engineSpeed(AbstractResourceRoute):
    """
    ...
    def __init__(self):
        self.abstract = super(router_engineSpeed, self)
        self.controller = ControllerEngineSpeed
...
app.api.add_resource(router_engineSpeed,
                     '/api/v1/enginespeed',
                     '/api/v1/enginespeed/<mongoid>',
                     endpoint='api-enginespeed',
