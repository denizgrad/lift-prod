...
__all__ = ["ControllerConsoleType"]


class ControllerConsoleType(AbstractResourceController):
    def __init__(self):
        self.helper = helper()
        self.abstract = super(ControllerConsoleType, self)
        self.main_model = ConsoleType
