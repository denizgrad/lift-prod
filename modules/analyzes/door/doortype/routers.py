...
from .controller import ControllerDoorType


class router_doorType(AbstractResourceRoute):
    """
    ...
    def __init__(self):
        self.abstract = super(router_doorType, self)
        self.controller = ControllerDoorType
...
app.api.add_resource(router_doorType,
                 '/api/v1/door/type',
                 '/api/v1/door/type/<mongoid>',
                 endpoint='api-door-type',
