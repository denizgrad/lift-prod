...
from .controller import ControllerDoorSize


class router_doorSize(AbstractResourceRoute):
    """
    ...
    def __init__(self):
        self.abstract = super(router_doorSize, self)
        self.controller = ControllerDoorSize
...
app.api.add_resource(router_doorSize,
                 '/api/v1/door/size',
                 '/api/v1/door/size/<mongoid>',
                 endpoint='api-door-size',
