...
from modules.analyzes.door.controller import ControllerDoor
from modules.user.auth.routers import token_required
from resources import app


class router_door(AbstractResourceRoute):
    """
    ...
    def __init__(self):
        self.abstract = super(router_door, self)
        self.controller = ControllerDoor
...
app.api.add_resource(router_door,
                     '/api/v1/door',
                     '/api/v1/door/<mongoid>',
                     endpoint='api-door',
