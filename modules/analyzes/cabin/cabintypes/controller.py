...
from .models import CabinType

__all__ = ["ControllerCabinTypes"]
class ControllerCabinTypes(AbstractResourceController):
    def __init__(self):
        self.helper = helper()
        self.abstract = super(ControllerCabinTypes, self)
        self.main_model = CabinType
