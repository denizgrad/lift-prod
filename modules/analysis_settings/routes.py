...
from .controller import ControllerAnalysisSettings as MainController

__all__ = ['route_analysissettings']


class route_analysissettings(AbstractResourceRoute):

    def __init__(self):
        self.abstract = super(route_analysissettings, self)
